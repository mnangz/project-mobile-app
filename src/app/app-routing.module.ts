...
const routes: Routes = [
  ...
  { path: 'scanned',
    data: { preload: true },
    loadChildren: './pages/modal/scanned/scanned.module#ScannedPageModule', canActivate: [AuthGuardService] },
  { path: 'valid-questionnaire', loadChildren: './pages/valid-questionnaire/valid-questionnaire.module#ValidQuestionnairePageModule', canActivate: [AuthGuardService] },
  { path: 'questionnaire', data: { preload: true }, loadChildren: './pages/questionnaire/questionnaire.module#QuestionnairePageModule', canActivate: [AuthGuardService] },
  { path: 'search', loadChildren: './pages/search/search.module#SearchPageModule', canActivate: [AuthGuardService] },
  { path: 'manual-search', loadChildren: './pages/manual-search/manual-search.module#ManualSearchPageModule', canActivate: [AuthGuardService] },
  { path: 'all-questionnaires', loadChildren: './all-questionnaires/all-questionnaires.module#AllQuestionnairesPageModule', canActivate: [AuthGuardService] },
  { path: 'q-survey', loadChildren: './pages/modal/q-survey/q-survey.module#QSurveyPageModule', canActivate: [AuthGuardService] },
  { path: 'qsearch', loadChildren: './pages/qsearch/qsearch.module#QsearchPageModule', canActivate: [AuthGuardService] },
